...
namespace cv { namespace dnn { namespace cuda4dnn { namespace csl { namespace device {
    ...
    namespace detail {
        using return_type = decltype(dim3::x);

        template <int>  __device__ return_type getGridDim();
        template <> inline __device__ return_type getGridDim<0>() { return gridDim.x; }
        template <> inline __device__ return_type getGridDim<1>() { return gridDim.y; }
        template <> inline __device__ return_type getGridDim<2>() { return gridDim.z; }

        template <int> __device__ return_type getBlockDim();
        template <> inline __device__ return_type getBlockDim<0>() { return blockDim.x; }
        template <> inline __device__ return_type getBlockDim<1>() { return blockDim.y; }
        template <> inline __device__ return_type getBlockDim<2>() { return blockDim.z; }

        template <int> __device__ return_type getBlockIdx();
        template <> inline __device__ return_type getBlockIdx<0>() { return blockIdx.x; }
        template <> inline __device__ return_type getBlockIdx<1>() { return blockIdx.y; }
        template <> inline __device__ return_type getBlockIdx<2>() { return blockIdx.z; }

        template <int> __device__ return_type getThreadIdx();
        template <> inline __device__ return_type getThreadIdx<0>() { return threadIdx.x; }
        template <> inline __device__ return_type getThreadIdx<1>() { return threadIdx.y; }
        template <> inline __device__ return_type getThreadIdx<2>() { return threadIdx.z; }
    }
