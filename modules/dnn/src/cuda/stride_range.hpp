...
#ifndef OPENCV_DNN_SRC_CUDA_STRIDE_RANGE_HPP
#define OPENCV_DNN_SRC_CUDA_STRIDE_RANGE_HPP
...
namespace cv { namespace dnn { namespace cuda4dnn { namespace csl { namespace device {
    ...
    public:
        ...
        public:
            ...
            __device__ iterator& operator++() {
                pos += static_cast<index_type>(detail::getBlockDim<dim>());
                return *this;
            }
...
#endif /* OPENCV_DNN_SRC_CUDA_STRIDE_RANGE_HPP */
