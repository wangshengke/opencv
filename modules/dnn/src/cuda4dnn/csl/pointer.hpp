...
#ifndef OPENCV_DNN_CUDA4DNN_CSL_POINTER_HPP
#define OPENCV_DNN_CUDA4DNN_CSL_POINTER_HPP
...
namespace cv { namespace dnn { namespace cuda4dnn { namespace csl {
     ...
     *
     *  DevicePtr wraps raw pointer and mimics behaviour of raw pointers. It does
     *  not implicitly convert to a raw pointer. This ensures that accidental mixing
     *  of host and device pointers do not happen.
     *
...
#endif /* OPENCV_DNN_CUDA4DNN_CSL_POINTER_HPP */
